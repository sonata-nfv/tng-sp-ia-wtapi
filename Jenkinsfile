    ...
    stage('Promoting release v5.1') {
      ...
      stages {
        stage('Generating release') {
          steps {
            sh 'docker tag registry.sonata-nfv.eu:5000/tng-sp-ia-wtapi:latest registry.sonata-nfv.eu:5000/tng-sp-ia-wtapi:v5.1'
            sh 'docker tag registry.sonata-nfv.eu:5000/tng-sp-ia-wtapi:latest sonatanfv/tng-sp-ia-wtapi:v5.1'
            sh 'docker push registry.sonata-nfv.eu:5000/tng-sp-ia-wtapi:v5.1'
            sh 'docker push sonatanfv/tng-sp-ia-wtapi:v5.1'
          }
        }
      }
    }
